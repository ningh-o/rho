...
const char *kernel_wat_src(void) {
  return
    ...
    "  ;; panic: \"panic: <msg>\\n\" to stderr, exit 101 — three\n"
    "  ;; single-iovec writes: some runtimes (wasmtime 40.0.0) write\n"
    "  ;; only the first iovec of a multi-iovec fd_write, silently\n"
    "  ;; swallowing the message and the newline\n"
    ...
    "    (i32.store (i32.const 8) (i32.const 2056))\n"
    ...
    "    (drop (call $fd_write (i32.const 2) (i32.const 0)\n"
    "                          (i32.const 1) (i32.const 24)))\n"
    "    (drop (call $fd_write (i32.const 2) (i32.const 8)\n"
    "                          (i32.const 1) (i32.const 24)))\n"

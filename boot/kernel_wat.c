...
const char *kernel_wat_src(void) {
  return
    ...
    "                          (i32.const 1) (i32.const 16))))\n"
    "  ;; format-build scratch: [64, 65536); overflow = defined panic\n"
    ...
    "        (drop (call $fd_write (i32.const 2) (i32.const 16)\n"
    "                              (i32.const 1) (i32.const 28)))\n"
    "        (call $rho_panic (i32.const 2048) (i32.const 7))))\n"
    "    (local.set $i (i32.const 0))\n"
    "    (block $d (loop $c\n"
